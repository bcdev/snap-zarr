...
final class WriterPanel extends javax.swing.JPanel {
    ...
    void store() {
        ...
        // Example:
        // Preferences.userNodeForPackage(WriterPanel.class).putBoolean("someFlag", someCheckBox.isSelected());
        // or for org.openide.util with API spec. version >= 7.4:
        // NbPreferences.forModule(WriterPanel.class).putBoolean("someFlag", someCheckBox.isSelected());
        // or:
